...
class DatabaseHandler
{
    ...
    function __construct(string $database_name, string $servername, string $user_login, string $username) {
    ...
    public function connect(): int {
        $this->connection = new mysqli($this->servername, $this->username, $this->user_login, $this->database_name);
        return 0;
    }
